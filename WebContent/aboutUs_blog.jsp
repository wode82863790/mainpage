			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10  animate-box" id="about-us">
						...
						<div class="row">
							<c:forEach items="${requestScope.queryBlog }" var="list"
								varStatus="num">
								<div class="col-md-4">
									<div class="fh5co-portfolio animate-box">
										<a
											href="${contextPath}/queryAboutUsBlogInner?id=<c:out value="${list.getBlog_id()}" />">
											<div class="portfolio-entry"
												style="background-image: url(${contextPath}/<c:out value="${list.getBlog_banner()}" />);"></div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<img src="${contextPath}/portfolio-4.jpg" alt="news2"
						class="img-responsive img-rounded	">
				</div>
			</div>
			<!-- /.modal-content -->
