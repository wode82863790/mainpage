	...
	<div id="page">
		...
		<div id="fh5co-blog">
			<div class="container">
				...
				<div class="row"
					style="-webkit-box-shadow: 0px 14px 33px -9px rgba(0, 0, 0, 0.09); -moz-box-shadow: 0px 14px 33px -9px rgba(0, 0, 0, 0.09); box-shadow: 0px 14px 33px -9px rgba(0, 0, 0, 0.09);">
