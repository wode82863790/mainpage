				...
				<div class="row">
					...
					<div class="col-md-10  animate-box" id="about-us">
						...
						<div class="VivaTimeline">
							<dl>
								<c:forEach items="${requestScope.queryHonor }" var="list"
									varStatus="num">
									<dd class="pos-right clearfix">
										<div class="circ"></div>
										<div class="time">
											<c:out value="${list.getHonor_date()}" />
										</div>
										<div class="events">
											<div class="events-header">
												<c:out value="${list.getHonor_title()}" />
											</div>
											
											<div class="events-footer">
												<img alt="" class="img-responsive"
													src="${contextPath}/<c:out value="${list.getHonor_src()}"/>">
													<c:out value="${list.getHonor_inner()}" />
											</div>
										</div>
									</dd>
								</c:forEach>
